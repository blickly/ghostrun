...
errbar(means$Phones, means$maxl, means$maxl+devs$maxl, means$maxl-devs$maxl, type="b", pch=5, errbar.col="red", col="red", log = 'x', main="Server Queue Latency", xlab="# Phones", ylab="Wait time (ms)")
...
errbar(pmeans$Phones, pmeans$updater, pmeans$updater+pdevs$updater, pmeans$updater-pdevs$updater, type="b", errbar.col="purple4", col="purple4", log = 'x', main="Phone Update Rate", xlab="# Phones", ylab="Time Between Posts (ms)")
title( main="Update Rate")

dev.copy2pdf(file="phoneUpdateRate.pdf")

errbar(pmeans$Phones, pmeans$d2, pmeans$d2+pdevs$d2, pmeans$d2-pdevs$d2, type="b", pch=1, errbar.col="red", col="red", log = 'x', main="Update Rate Broken Down", xlab="# Phones", ylab="Time (ms)")
